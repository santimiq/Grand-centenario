                ...
                <div className="col-12 col-md-12">
                  <PortfolioDetails.Content>
                    <PortfolioDetails.Lista as="ul">
                      ...
                      <li>
                        <span>
                          Piso de porcelanato en sala, comedor, baños y cocina.
                        </span>
                      </li>
                      <li>
                        <span>
                          Tapiz en sala, comedor y en recamára principal, según
                          prototipo.
                        </span>
                      </li>
                      <li>
                      ...
                      <li>
                        <span>Canceles de cristal templado en regaderas.</span>
                      </li>
                      <li>
                        <span>
                          Puerta principal contra incendios y chapa de seguridad
                          de tarjeta.
                        </span>
                      </li>
